...
Fork the project [on GitHub](https://github.com/geut/nanoerror) and check out your copy locally.

```bash
$ git clone git@github.com:username/nanoerror.git
$ cd nanoerror
$ npm install
$ git remote add upstream git://github.com/geut/nanoerror.git
```
